...
class WaferPickup:
    ...
    def physics_step(self, step_size):
        ...
        # Phase 3: 물체 위쪽으로 접근
            ...
            _target_position = wafer_pos - self.robot_position
            _target_position[2] += 0.3  # wafer 기준 상대적으로 위쪽
        ...
        # Phase 4: 물체를 잡기 위해 하강
            ...
            # 매 스텝마다 wafer 실시간 위치 추적
            wafer_pos, _ = self.wafer.get_world_pose()
            
            _target_position = wafer_pos - self.robot_position
            _target_position[2] += 0.05  # wafer 표면보다 살짝 위 (흡착 여유)
